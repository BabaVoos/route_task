...
mixin _$HomeState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ProductData> products) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductData> products)? success,
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(final List<ProductData> products) : _products = products;
  ...
  @override
  String toString() {
    return 'HomeState<$T>.success(products: $products)';
  }
...
abstract class Success<T> implements HomeState<T> {
  const factory Success(final List<ProductData> products) = _$SuccessImpl<T>;
